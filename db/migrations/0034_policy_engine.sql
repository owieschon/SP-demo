...
begin
  ...
  ('nl.customer_prices', 'agreed_by', 'Agreed by',
   ...
   '', 'app', '', '2', false),
  ('nl.customer_prices', 'break_policy', 'When a ladder may go under it',
   'Whether a published quantity ladder may price under this agreement, or whether the agreed price is firm at every quantity.',
   '', 'app', '', 'better of', true),
