...
/**
 * A fixed timestamp for the generated files. Without it, pdf-lib stamps the
 * moment of writing into every PDF, and rebuilding the fixtures would change
 * every byte of them for no reason anybody could see.
 */
const STAMP = new Date('2026-09-16T14:00:00Z');
