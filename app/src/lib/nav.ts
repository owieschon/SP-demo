/*
  ...
  entry that 404s is worse than a missing one:
    ...
    Controls  /policies, /dictionary, /agents, /people
	...
	},
	{
		...
		items: [
			...
			},
			{
				href: routes.context(),
				label: 'Context',
				hint: 'What the agents know about an account, and where each piece came from',
				icon: Library
			},
			{
			...
			// Reserved: /policies, /dictionary, /agents, /people.
		]
	}
];
